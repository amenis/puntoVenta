   ...
   if($caja=="0"){
    ...
    $exec_credito=$db->consulta($cadena_credito);
      if($db->numero_de_registros($exec)>0){
        ...
        echo "<th>Status</th>";
        echo "<th>Tipo</th>";
        echo "<th class='no-print'>Detalle</th>";
        echo "</tr>";
        echo "</thead>";
        echo "<tbody>";
           ...
           echo "<td class='no-print'><button class='btn btn-xs btn-primary confirmacion ' id='".$elid."' onclick='muestra_detalle(this.id);'><i class='fa fa-search'></i> Detalles.</button></td>";
           $monto1=0.00;
          echo "</tr>";
          }
          echo "</tbody>";
