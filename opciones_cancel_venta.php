...
$caja1 =  $_SESSION['numero_de_caja'] == 1 ? 'selected' : ''; 
$caja2 =  $_SESSION['numero_de_caja'] == 2 ? 'selected' : ''; 
$caja3 =  $_SESSION['numero_de_caja'] == 3 ? 'selected' : ''; 
$caja4 =  $_SESSION['numero_de_caja'] == 4 ? 'selected' : ''; 
...
echo "<form class='form-horizontal'>";
 ...
 echo "<label for='tipo_buscar' class='col-sm-3 control-label'>Selecciona el # de Caja:</label>
             <div class='col-sm-3'>
                ...
                <option value='1' ".$caja1." >Caja 1</option>
                <option value='2' ".$caja2." >Caja 2</option>
                <option value='3' ".$caja3." >Caja 3</option>
                <option value='4' ".$caja4." >Caja 4</option>
                </select>
             </div>";
   echo "</div>";
