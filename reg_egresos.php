    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class='box-body'>
            <?
              if(preg_match('/(GASTA)/',$_SESSION['permisos'])){
            ?>
            <form class="form-horizontal">
              ...
              <div class='form-group'>
                ...
                <div class="col-sm-2">
                  <input type="text" class="form-control" id="fecha" autocomplete="off" placeholder='Fecha del gasto...' value="<?php echo date('Y-m-s') ;?>">
                </div>
              </div>
              <!--
              <div class='form-group'>
