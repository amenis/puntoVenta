          ...
          <div class='row'>
           <div class='col-md-12'>
             <div class='nav-tabs-custom'>
                  ...
                  <li><a href="#cambios" data-toggle="tab">Ver Articulos</a></li>
               ...
               <div class="tab-content">
                  <div class="tab-pane active" id="altas">
                    <?
                    if(preg_match('/(ARTA)/',$_SESSION['permisos'])){
                    ?>
                  ...
                  -->
                    ...
                    <div class='form-group'>
                      ...
                      <div class="col-sm-2">
                        <input type="text" class="form-control cantidades" id='costos' value="1" placeholder='Costo del articulo...'
                    ...
                    <div class="col-sm-2">
                    <input type="text" class="form-control cantidades" id='precio' placeholder='Precio al publico del articulo...' value ="1"
                     data-inputmask="'alias': 'numeric', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'placeholder': '0' ">
                    </div>
                    </div>
                    <?php 
                          ...
                          <select name="linea" id="linea"  class='form-control select2'>
                            ...
                            <?php 
                              ...
                              while($rowLineas=mysqli_fetch_array($selectLinea)){
                                echo '<option value="'.$rowLineas['linea'].'">'.$rowLineas['descripcion'].'</option>';
                              }
                            ?>
                          </select>
                        </div>
                        ...
                        <div>
                          <select name="grupo" id="grupo" class="form-control">
                            <?php 
                              ...
                              while($rowGrupo=mysqli_fetch_array($selectGrupo)){
                    ...
                    <?
                      ...
                      echo "<H3>NO CUENTA CON LOS PERMISOS NECESARIOS</H3>";
                    }
                    ?>
                  </div><!-- /.tab-pane -->
                  ...
                  <div class="tab-pane" id="bajas">
                    <?
                    if (preg_match('/(ARTC)/',$_SESSION['permisos'])) {
