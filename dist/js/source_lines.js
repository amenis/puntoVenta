...
function procesa_lineas(){
         ...
         type: 'POST',
         data: 'linea='+linea+'&descripcion='+descripcion,
...
function actualiza_lineas(){
       ...
       $.ajax({
         ...
         type: 'POST',
         data: "linea="+lineax+"&grupo='0' "+"&descripcion="+descripcionx,
         success: function(rxx){
