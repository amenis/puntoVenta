...
function sumatorias(){
  $(document).ready(function(){
    ...
    $('#tabla_ventas_credito > tbody > tr').each(function(){
         ...
         $("#total_credito").html("");
         $("#total_credito").html("<br><span class='label label-success'>Total: $ "+total_credito.toFixed(2)+"</span> | <span class='label label-success'>Cancelaciones: $ "+detalle_cancelado.toFixed(2)+"</span> | <span class='label label-danger'>Venta Neta: $ "+detalle.toFixed(2)+"</span>");
        });
       /*tabla de contado*/
        ...
        $('#tabla_ventas_contado > tbody > tr').each(function(){
         ...
         $("#total_contado").html("");
         $("#total_contado").html("<br><span class='label label-success'>Total: $ "+total_contado.toFixed(2)+"</span> | <span class='label label-success'>Cancelaciones: $ "+detalle_cancelado_contado.toFixed(2)+"</span> | <span class='label label-danger'>Venta Neta: $ "+detalle_contado.toFixed(2)+"</span>");
        });
        ...
        /*tabla de gastos*/
         ...
         $("#total_de_los_gastos").html("<br><span class='label label-success'>Total: $ "+total_gastos.toFixed(2)+"</span>");
        });
