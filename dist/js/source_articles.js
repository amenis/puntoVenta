...
function alta_articulo(){
          ...
          //if(codigo==""||descripcion==""||proveedor==""||linea==""||linea=="0"){
            ...
            $.ajax({
              ...
              type: 'POST',
              data: 'codigo='+codigo+'&codigostock=""'+'&descripcion='+descripcion+'&costo='+costos+'&precio='+precio+'&proveedor='+proveedor+'&linea='+linea+'&grupo='+grupo+'&fecha_caducidad=" "',
                 ...
                 var n = noty({
                  ...
                  buttons     : [
                   ...
                   {addClass: 'btn btn-danger',
                    ...
                    onClick : function ($noty){
                      var n = noty({
                        text: "El articulo ha sido dado de alta correctamente...!",
                        theme: 'relax',
                        layout: 'center',
                        type: 'information',
                        });
...
/*******************************************************************************************/
function busca_articulo(articulo){
...
function elimina_articulo(){
  ...
  function editar_articulo(articulo){
          ...
          $(document).ready(function() {
           ...
           url: 'editar_articulo.php',
           type: 'POST',
           data: 'codigo='+ articulo, //$("#codigo_busqueda").val(),
           success: function(x){
               if(x==0){
                alert("El codigo del articulo, no existe...");
                 $("#btn-buscar").prop('disabled', false);
...
function update_articulo(id){
            ...
            var costos= $("#Editcostos").val() ;
            var precio= $("#Editprecio").val();
            var proveedor=$("#Editproveedor").val();
            var linea= $("#Editlinea").val();
            //var grupo=$("#grupo").val();
            //var fecha_cad=$("#fecha_caducidad").val();
           
            var n = noty({
                   text: "Seguro que desea efectuar cambios en el articulo...?",
                   theme: 'relax',
                   layout: 'center',
                   type: 'information',
                   buttons     : [
                     {addClass: 'btn btn-primary',
                      ...
                      onClick : function ($noty){
                          ...
                          url: 'update_articulo.php',
                          type: 'POST',
                          data: 'id='+id+'&codigo='+codigo+'&descripcion='+descripcion+'&costo='+costos+'&precio='+precio+'&proveedor='+proveedor+"&linea="+linea,
                          success: function(x){
                            console.log(x);
                              var n = noty({
                              text: "Se ha actualizado la informacion la informacion del articulo...!",
                              theme: 'relax',
                              layout: 'center',
                              type: 'information',
                              timeout: 2000,
