...
$cadena="Select linea, grupo from lineas where linea=$linea ";
$exe=$db->consulta($cadena);
if($db->numero_de_registros($exe)>0){
  echo "EXISTE";
}else{
  $cadena2="Insert into lineas(linea,grupo,descripcion,marca_eliminada) values($linea,'0','$descripcion','NO')";
