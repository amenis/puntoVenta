          ...
          <h4 class='box-title'>Selecciona el numero de caja.</h4>
           ...
           <label for='numero_caja' class='col-sm-5 control-label'># de Caja:</label>
             <div class='col-sm-6'>
                ...
                <option value='1' <?php echo $seleccted = $_SESSION['numero_de_caja'] == 1 ? "selected" : "" ; ?> >Caja 1</option>
                <option value='2' <?php echo $seleccted = $_SESSION['numero_de_caja'] == 2 ? "selected" : "" ; ?> >Caja 2</option>
                <option value='3' <?php echo $seleccted = $_SESSION['numero_de_caja'] == 3 ? "selected" : "" ; ?> >Caja 3</option>
                <option value='4' <?php echo $seleccted = $_SESSION['numero_de_caja'] == 4 ? "selected" : "" ; ?> >Caja 4</option>
           ...
           <button class='btn btn-primary pull-right' onclick='trae_venta();' id='btn-sig' ><i class='fa fa-search'></i> Consultar...</button>
          </div>
          </div>
          </div>
