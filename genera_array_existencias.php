...
$busca_arts=$db->consulta("Select a.codigo, a.costo,e.cantidad from articulos a, existencias e where a.codigo=e.codigo and e.cantidad<>0 and e.cantidad <999");
    ...
    while($gt=$db->buscar_array($busca_linea)){
     $descripcion=$gt['descripcion'];
      ...
      if(in_array($array_existe[$descripcion],$array_existe)){
        $array_existe[$descripcion]['item1']=$array_existe[$descripcion]['item1'] + $cantidad; //($cantidad*$costo);
       }
