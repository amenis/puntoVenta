...
$consulta = $db->consulta("SELECT a.id, a.nombre as nombreusuario,a.clave,a.password, permisos FROM usuarios a WHERE a.clave='$usuario' AND a.Password='$password' ");
echo $db->numero_de_registros($consulta);
